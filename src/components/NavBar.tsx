  ...
  return (
    <div>
      ...
      <nav className="relative">
        <div className="flex justify-between bg-white w-full top-0 py-3">
          <ul className="flex ml-6">
            <li
              className="flex items-end text-base mx-2 font-bold relative cursor-pointer"
              onClick={() => {
            ...
            <li className="flex items-end font-bold text-base mx-2 text-custom-red cursor-pointer">
              <OfferSvg />
              Ofertas
              <Icon icon={arrowDownIcon} className="ml-2 w-6 h-6 mt-1" />
            </li>
            <li className="flex items-end text-base mx-2 cursor-pointer">
              Servicios
              <Icon
                icon={arrowDownIcon}
                className="ml-2 w-6 h-6 text-custom-blue-ligth"
          ...
          <ul className="flex mr-8">
            {navItems.map((item) => (
              <li
                key={item.path}
                className="font-normal text-base mx-2 cursor-pointer"
              >
