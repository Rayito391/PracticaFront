...
const OrderForm: React.FC = () => {
  ...
  return (
    <div className="w-144 h-72 rounded-lg mx-auto -mt-1 bg-white border border-white shadow-2xl">
      <div>
        <p className="font-semibold ml-5 mt-16">
          Escribe tu número de seguimiento
        </p>
        <div className="flex items-center ml-5">
          ...
          <Icon
            ...
            className={
              isValid
                ? "text-custom-blue-ligth w-7 h-7 ml-2 mr-4"
                : "text-red-500 w-7 h-7 ml-2 mr-4"
            }
          />
          <Icon
        ...
        <div className="text-sm mx-auto text-center mt-3">
          <p className="text-gray-800">
            <span className="text-custom-blue-ligth cursor-pointer hover:underline">
              Iniciar sesión
            </span>{" "}
