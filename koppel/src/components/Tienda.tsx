...
const Tienda: React.FC = () => {
  ...
  return (
    <div className="flex-col mt-4 mx-auto w-3/5">
      <p className="text-custom-blue cursor-pointer text-sm hover:text-custom-blue-ligth underline">
        Ubica tu tienda
      </p>
              ...
              <Icon
                ...
                className={`w-4 h-4 ${
                  selectedButtons.includes(button.id)
                    ? "text-custom-blue-ligth text-opacity-5"
                    : "text-custom-blue-ligth"
                }`}
              />
            </span>
            <p>{button.label}</p>
        ...
        <div className="flex flex-col w-1/3 h-full">
          <div className="relative bg-white mt-6 h-28 rounded-ss-lg">
            <input
              ...
              placeholder={
                isSearchingByName
                  ...
                  : "Ingrese la ciudad o código postal"
              }
            ...
            <div className="cursor-pointer absolute flex w-20 top-7 right-3 gap-4">
              <Icon
                icon="carbon:search"
                className="text-custom-blue-ligth w-6 h-6"
              />
              <Icon
            ...
            <p
              ...
              className="float-end mr-4 my-2 text-custom-blue-ligth cursor-pointer text-sm hover:text-opacity-80 underline"
            >
              {isSearchingByName
                ? "Buscar por ciudad o código postal"
