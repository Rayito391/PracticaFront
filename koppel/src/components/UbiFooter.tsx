            ...
            <div className="flex justify-between w-3/5 h-14 mx-auto mt-4">
                <div className="flex items-center">
                    ...
                    <figure className="w-20 h-8 bg-white ml-2 rounded-md">
                        <img className="w-4/5 ml-2 mt-1" src="https://ekata.com/wp-content/uploads/2023/08/accertify.svg" alt="logoFooter1" />
                    </figure>
                    <figure className="w-20 h-8 bg-white ml-2 rounded-md">
                        <img className="w-4/5 ml-2 mt-1"  src="https://compusoftme.com/wp-content/uploads/2023/01/230-2308139_if-you-purchase-a-globalsign-ssl-certificate-youll.png" alt="logoFooter2" />
                    </figure>
                </div>
