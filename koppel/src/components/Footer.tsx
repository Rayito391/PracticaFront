  ...
  return (
    <>
      <div className="flex w-full mt-14 bg-custom-dark-blue items-center">
        <button
          className="flex justify-center mt-1 w-full h-5 font-bold text-white"
          onClick={scrollToTop}
        >
          Ir arriba
      ...
      <footer className="flex flex-col bg-custom-dark-blue bottom-0">
        <div className="flex justify-between w-full h-20 mx-auto mt-4 bg-custom-dark-blue-x2">
          ...
          <div className="flex items-center gap-1  mr-72">
            <p className="font-base text-white text-xl">
        ...
        <div className="flex w-4/5 h-full my-8 mx-auto space-x-20 bg-custom-dark-blue text-white ">
          <div className="w-52 h-auto ">
            <p className="font-bold text-lg">ACERCA DE KOPPEL</p>
          ...
          <div className=" w-52 h-auto">
            <p className="font-bold text-lg">ATENCIÓN A CLIENTES</p>
            <ul className="text-base mt-8 space-y-3">
          ...
          <div className=" w-60 h-auto">
            <p className="font-bold text-lg">PUBLICACIONES KOPPEL</p>
            <ul className="text-base mt-8 space-y-3">
          ...
          <div className=" w-64 h-auto">
            <p className="font-bold text-lg">DESTACADOS</p>
            <ul className="text-base mt-8 space-y-3">
              ...
              <li className="hover:underline">
                Hot Fashion Niños y Adolescentes
              </li>
          ...
          <div className="w-4/5 mx-auto text-xs text-center text-white mt-1">
            <p>
              *Te llamaremos si es necesario para darle seguimiento a tu compra.{" "}
              ...
              exclusivos de Coppel.com. Los abonos quincenales, el plazo o el
              pago inicial pueden variar según el margen de crédito y el
              historial de pago de cada cliente. Los quincenales contemplan: 24,
              36, 48, 60 o 72 quincenas para muebles y 24 quincenas para ropa.
              Los productos de Marketplace que lleves con tu crédito Coppel,
              cuentan con un plazo de 24 quincenas y son financiados con Coppel
              Pay.
            </p>
          </div>
