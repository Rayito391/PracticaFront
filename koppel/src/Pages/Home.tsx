...
const Home: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="w-4/5 h-auto mt-5 mx-auto flex space-x-1">
        {homeCardData.map((dataHome, index) => (
          <HomeCard
            key={index}
            imgSource={dataHome.imgSource}
            imgAlt={dataHome.imgAlt}
          />
        ))}
      </div>
      <Footer />
