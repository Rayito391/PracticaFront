...
const Home: React.FC = () => {
    ...
    const displayedProducts = products.slice(currentIndex * ITEMS_PER_PAGE, (currentIndex + 1) * ITEMS_PER_PAGE);
        ...
        <>
            ...
            <div className="mx-auto w-4/5 h-auto -mt-4">
                <div className="ml-5">
                    ...
                    <div className={`grid ${expanded ? 'grid-cols-8' : 'grid-cols-8'} gap-4 transition-all duration-700 ease-in-out`}>
                        {departments.slice(0, expanded ? departments.length : 7).map((department, index) => (
                            <DepartmentCard 
                                key={index} 
                        ...
                        >
                            <Icon icon={expanded ? arrowUpIcon : arrowDownIcon} className="w-14 h-14 text-white" />
